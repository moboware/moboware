...
public:
  ...
  void OrderInsert(OrderInsertData &&orderInsert, const boost::asio::ip::tcp::endpoint &endpoint);
  ...
  [[nodiscard]] const OrderBidBook_t &GetBidOrderBook() const
  {
    return m_Bids;
  }

  [[nodiscard]] const OrderAskBook_t &GetAskOrderBook() const
  {
    return m_Asks;
  }
