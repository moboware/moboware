...
public:
  ...
  using ReceiveDataFunction =
    std::function<void(const std::shared_ptr<Session>& session, const std::array<char, maxBufferSize>& readBuffer, const std::size_t bytesRead)>;
